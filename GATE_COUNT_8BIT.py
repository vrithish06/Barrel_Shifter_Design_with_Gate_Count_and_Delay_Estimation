...
def parse_verilog(file_path):
    ...
    # Stage definitions for 8-bit barrel shifter
    stages = {
        1: r'// 4-bit shift',  # Marker for stage 1
        2: r'// 2-bit shift',  # Marker for stage 2
        3: r'// 1-bit shift',  # Marker for stage 3
    }
...
def main():
    ...
    file_path = "barrel_shifter_8bit.v"
